...
export class NovedadesController {
  ...
  @ApiOperation({
    summary:
      'Registrar una novedad (Solo ADMIN y RECURSOS_HUMANOS). Requiere que la nómina esté en estado ABIERTA',
  })
  @ApiResponse({ status: 201, description: 'Novedad registrada exitosamente.' })
  @ApiResponse({
    status: 404,
    description: 'Empleado o nómina no encontrados.',
  })
  @ApiResponse({
    status: 409,
  ...
  @ApiOperation({
    summary:
      'Listar novedades, con filtros opcionales por empleado, nómina o tipo',
  })
  ...
  @ApiOperation({
    summary: 'Obtener todas las novedades de un período de nómina',
  })
  ...
  @ApiOperation({
    summary:
      'Actualizar una novedad (Solo ADMIN y RECURSOS_HUMANOS). Requiere que la nómina siga en estado ABIERTA.',
  })
  @ApiResponse({ status: 200, description: 'Novedad actualizada.' })
  @ApiResponse({ status: 404, description: 'Novedad no encontrada.' })
  @ApiResponse({
    status: 409,
    description: 'La nómina ya no está en estado ABIERTA.',
  })
  @Roles(EmpleadoRole.ADMIN, EmpleadoRole.RECURSOS_HUMANOS)
  @Patch(':id')
  ...
  @ApiOperation({
    summary:
      'Eliminar una novedad (Solo ADMIN y RECURSOS_HUMANOS). Requiere que la nómina siga en estado ABIERTA.',
  })
